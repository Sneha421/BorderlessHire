...
export function HeroSection({ featuredCount, totalJobs }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-slate-200/70 bg-[#061428] text-white shadow-card dark:border-slate-800">
      <div className="absolute inset-0">
        <Image
          src="/hero-network.png"
          alt="Networked globe visualization representing global mobility and sponsorship pathways"
          fill
          priority
      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 px-5 py-12 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-16">
        ...
        <div className="flex items-end lg:justify-end">
          <div className="w-full max-w-md rounded-[1.75rem] border border-white/10 bg-slate-950/40 p-5 backdrop-blur-md">
